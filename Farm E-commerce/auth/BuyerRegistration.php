        ...
        <main class="my-form">
            <div class="cotainer">
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <div class="card">
                        <div class="card-header" style="background-color:#292b2c"><h4 style="font-style:bold;color:goldenrod">Register as Buyer</h4></div>
                            <div class="card-body border border-dark">
                                <form name="my-form" action="BuyerRegistration.php" method="post">
                                    ...
                                    <br>
                                    <div class="col-md-6 offset-md-4">
                                        <label id="account" class="text-left"><a id='link' href="BuyerLogin.php"><b style="color:black"> I Aleady have an account</b></a></label>
                                    </div>
                                </form>
                            </div>
                        </div>
